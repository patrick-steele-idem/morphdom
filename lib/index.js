...
var specialElHandlers = {
     ...
     * initial value.  Similar for the "checked" attribute.
     */
    ...
    for (i = attrs.length - 1; i >= 0; i--) {
        ...
        if (attr.specified !== false) {
            ...
            if (!foundAttrs.hasOwnProperty(attrName)) {
                fromNode.removeAttributeNS(attr.namespaceURI, attr.name);
            }
        }
    }
}
            ...
            outer: while (curToNodeChild) {
                ...
                while (curFromNodeChild) {
                    ...
                    if (curFromNodeType === curToNodeChild.nodeType) {
                        ...
                        if (curFromNodeType === Node.ELEMENT_NODE) { // Both nodes being compared are Element nodes
                        ...
                        } else if (curFromNodeType === Node.TEXT_NODE) { // Both nodes being compared are Text nodes
                            isCompatible = true;
